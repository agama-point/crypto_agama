...
f7_b = ((0,3),(1,0),(1,3),(2,1),(3,2),(4,1),(4,4),(4,6),(5,0),(5,5),(6,4),(6,6)) #i
f7_C = ((0,2),(0,6),(1,0),(1,5),(2,4),(3,2),(3,6),(4,1),(4,5),(5,0),(5,3),(6,2))
f7_c = ((0,1),(0,5),(1,4),(2,0),(2,3),(2,6),(3,5),(4,2),(5,1),(5,4),(6,0),(6,3)) #i


# t48 = "123456789012345678901234567890123456789012345678x" #48+1
# matrix 7x7: mf=7, ccw: counterclockwise

def fleissner_decrypt(text, f=f7_B, mf=7,center="*", ccw = True, debug=False):
   f_temp ="-"*mf*mf
   print(text,len(text))
   # f_temp[0] = center
   i = int(3*mf + 3)
